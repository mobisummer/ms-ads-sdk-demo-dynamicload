...
public class ReflectHelper {
  ...
  public static boolean setField(Class<?> targetClass, String fieldName, Object value) {
    try {
      getField(targetClass, fieldName).set(null, value);
      return true;
    } catch (Throwable e) {
      return false;
    }
  ...
  public static Object invokeStatic(Class<?> classType,
                                    String methodName,
                                    Class<?>[] argTypes,
                                    Object... args) {
    try {
  ...
  public static Object construct(Class<?> clazz, Class<?>[] argTypes, Object... args) {
    try {
